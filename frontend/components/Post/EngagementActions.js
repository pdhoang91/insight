...
const MoreOptionsMenu = ({ post, onClose }) => {
  ...
  return (
    <div className="absolute right-0 mt-2 w-48  shadow-elevated border border-medium-border rounded-card overflow-hidden z-50">
      <div className="py-2">
        <button
...
export const FloatingEngagementActions = ({ post, commentsCount, className = '' }) => {
  return (
    <div className={`fixed left-6 top-1/2 transform -translate-y-1/2 z-40 ${className}`}>
      <div className="border border-medium-border rounded-card shadow-elevated p-2">
        <EngagementActions
          post={post}
