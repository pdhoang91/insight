...
//   return (
//     <div className="flex items-center space-x-4 mb-6 pb-2 overflow-x-auto flex-nowrap custom-scrollbar">
//       {/* Nút thêm tab nếu có người dùng */}
//       {user && (
//         <button
//           onClick={handleIconClick}
//           className="flex-shrink-0 flex items-center justify-center text-gray-600 hover:text-gray-900"
//         >
//           <IoIosAdd size={24} />
//         </button>
//       )}
    ...
    <div className="relative flex items-center mb-6 pb-2">
      ...
      {showLeftArrow && (
        <button
          ...
          className="absolute left-0 z-10 flex items-center justify-center w-8 h-8 self-center transition-opacity duration-300"
        >
      ...
      {showRightArrow && (
        <button
          ...
          className="absolute right-0 z-10 flex items-center justify-center w-8 h-8 self-center transition-opacity duration-300"
        >
